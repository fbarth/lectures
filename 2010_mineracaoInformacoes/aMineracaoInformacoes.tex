...
veículos de notícias (D0 = 17/07/2007) 
\end{Slide}
...
\begin{PartSlide}{\textbf{Quais são os componentes deste sistema?}}
\end{PartSlide}


\begin{Slide}{Componentes}
  \begin{itemize}
  \item Que objetos são relevantes para a criação da hipótese?
...
\includegraphics[width=0.85\textwidth]{figuras/arvoreDecisao.jpg}
\tiny
\begin{itemize}
...
\begin{itemize}
\item Notícias, patentes, artigos, mensagens de twitter...
...
\begin{center}
\includegraphics[width=8cm]{figuras/agrupamentoNoticias.png}
\end{center}
\end{Slide}
...
\begin{PartSlide}{Classificação de documentos}
\end{PartSlide}

\begin{Slide}{Análise de Sentimento em mensagens no Twitter}
\begin{centering}
\includegraphics[width=8cm]{figuras/classificacaoSentimento.png}
\end{centering}
...
\begin{Slide}{Classificação e Filtragem de Notícias}
\begin{centering}
...
\begin{PartSlide}{Agrupamento de documentos}
\end{PartSlide}
...
\begin{PartSlide}{Minerando o log de um servidor Web}
\end{PartSlide}

\begin{Slide}{Exemplo típico de log}
\begin{centering}
\includegraphics[width=7cm]{figuras/log.png}
\end{centering}
\end{Slide}

\begin{Slide}{Pré-processamento do log: identificação de usuários}
\begin{centering}
\includegraphics[width=7cm]{figuras/user.png}
\end{centering}
\end{Slide}

\begin{Slide}{Pré-processamento do log: identificação das seções}
\begin{centering}
\includegraphics[width=8cm]{figuras/secao.png}
\end{centering}
\end{Slide}

\begin{Slide}{Matriz de transações}
\begin{centering}
\includegraphics[width=8cm]{figuras/secao-page.png}
\end{centering}
\end{Slide}
...
\bibliography{doutorado,mestrado,publicacoes,atech,posDoutorado}
