...
\title{Oficina: construção de modelos descritivos e preditivos
  utilizando R} 
...
O objetivo desta oficina é apresentar exemplos de construção de
modelos descritos e preditivos utilizando a linguagem de programação
R.
\end{Slide}
...
\begin{Slide}{Sumário}
\begin{itemize}
\item Conceitos: aprendizagem de máquina, \textit{knowledge discovery
