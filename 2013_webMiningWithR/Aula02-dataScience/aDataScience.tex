...
\title{Web Data Mining com R: contexto} 
...
veículos brasileiros de notícias ($D_{0}$ = 17/07/2007) 
\end{Slide}
...
\begin{Slide}{Big Data é um conceito relativo}
\begin{itemize}
\item O que é \emph{grande hoje}...
\item Pode não ser \emph{grande amanhã}...
\end{itemize}
\end{Slide}
...
\item Recomendação de livros, filmes, restaurantes e empregos.
\end{itemize}
\newpage
...
%\begin{Slide}{Ciclo típico de um projeto}
%\begin{figure}[htbp]
%\centering 
%\resizebox*{1\columnwidth}{0.8\textheight}
...
A área de Web Data Mining tem como objetivo descobrir \emph{conhecimento
