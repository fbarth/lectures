...
\item Identificar grupos de usuários com perfil similar em
  ambientes de escrita colaborativa. 
%\item Identificar um padrão de consumo de clientes.
\end{itemize}
\end{Slide}
...
\begin{itemize}
\item Notícias, patentes, artigos...
\item \emph{Para tirar proveito desta informação é
    necessário organizá-la de alguma forma}:
\begin{itemize}
\item Agrupamento de notícias, patentes, artigos.
\item Classificação, Recomendação e Filtragem de Notícias.
\end{itemize}
\end{itemize}
\end{Slide}
...
\begin{Slide}{Que informações um Wiki tem?}
\begin{table*}[htpb]
\centering
\tiny
\vspace{0.2cm}
...
\end{table*}
\tiny
Exemplo de histórico de criação e alteração de páginas em um \textsc{Wiki}.
\end{Slide}
...
\begin{itemize}
\item Caso sobre conhecimento médico: \textit{Data Mining}.
\item Agrupamento, classificação e filtragem de documentos:
  \textit{Text Mining}.
